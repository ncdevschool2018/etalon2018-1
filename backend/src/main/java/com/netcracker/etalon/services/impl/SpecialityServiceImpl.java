...
public class SpecialityServiceImpl implements SpecialityService {
    ...
    @Override
    public SpecialityEntity getSpecialitiesByFacultyId(String facultyId) {
        List<SpecialityEntity> specialitiesByFaculty_id = specialityRepository.findSpecialitiesByFaculty_Id(Integer.valueOf(facultyId));
